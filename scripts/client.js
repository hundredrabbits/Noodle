...
function Client () {
  ...
  this.install = function (host) {
    ...
    this.acels.set('File', 'Export .zoe', 'CmdOrCtrl+Shift+S', () => { download('sprite.zoe', zoeRead(this.context, this.el.width, this.el.height), 'octect/stream') })
    this.acels.set('File', 'Export .dsk', 'CmdOrCtrl+Alt+S', () => { insertDisk(zoeRead(this.context, this.el.width, this.el.height)) })
  ...
  // https://wiki.xxiivv.com/zoe_format
  ...
  function insertDisk (uint8a) {
    const xmlhttp = new XMLHttpRequest()
    xmlhttp.open('GET', 'links/128.dsk', true)
